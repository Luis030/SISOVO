...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(isset($_POST['idclase'])){
        ...
        $q = isset($_POST['q']) ? $_POST['q'] : '';
        $sql = "SELECT ID_Alumno, ID_Usuario, Nombre, Apellido, Cedula, TIMESTAMPDIFF(YEAR, Fecha_Nac, CURDATE()) AS Edad, Celular_Padres, Mail_Padres, CONCAT(Grado, '°') AS Grado FROM alumnos WHERE Estado=1;";
    } else {
        $q = isset($_POST['q']) ? $_POST['q'] : '';
